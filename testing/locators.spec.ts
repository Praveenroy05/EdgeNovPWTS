...
// Locators - To identify the element on the web page is known as locating an element.
 ...
 * 
 * tagname.classValue or .classValue or c. [class='classvalue'] 
 ...
 * #form #username
 * 
 * first() - first matching element with the locator
 * last() - last matching element with the locator
 * nth(index) - nth(0) - nth(1) // Index starts with 0
 * 
 * // Syntax to match the locator uniquely if the locators is matching with multiple elements on the webpage. Selector can be anything. Ex: - .classValue
 * 
 page.locator(".mr-sm-2").first() // It will match with first matchig element on the webpage
 page.locator(".mr-sm-2").last() // it will match with last matchig element on the webpage
 page.locator(".mr-sm-2").nth(5) // index start with 0
...
// In xpath the index will starts with 1 
...
//div[@class='form-group']/input[@id='userEmail']
 ...
 // - to move to any of the child element, can be immediate child or grand/great grant/descandant
...
1. page.getByRole() - By using the role of an element
2. page.getByText() - By using the text value of an element
3. page.getByPlaceholder() - By using the "placeholder" attribute of an element
4. page.getByTestId() - By using the "data-testid" attribute of an element
5. page.getBylabel() - By using the label tag of an element or label as an attribute
6. page.getByAltText() - By using the "alt" attribute specially for image element
7. page.getByTitle() - By using the "title" attribute of an element

codegen - built-in playwright tool
...
2. page.getByText('Test login', {exact: true}) to locate by text content.It works in a contains manner.
...
4. page.getByPlaceholder('First Name')  - to locate an input/textbox element by "placeholder" as an attribute.
